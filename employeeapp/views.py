    ...
    if islogin(request):
        if request.method == "POST":
            ...
            try:
                ...
                msg = "invalid data"
                return render(request, "employee_chpwd.html", {"msg": msg})
        return render(request, "employee_chpwd.html", {})
    else:
        return render(request, "employee_login.html", {})
...
def employee_edit_profile(request):
    email = request.session["email"]
    employ = Employee.objects.get(email=email)
    print(employ)
    return render(request, "employee_edit_profile.html", {"employ": employ})
...
def employee_update_profile(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            print(e)
            return render(request, "employee_home.html", {"msg": "update successfully"})
    return render(request, "employee_edit_profile.html", {"employee":data})
